        ...
        ->insert([
            [
                ...
                'options'                => json_encode([
                    ...
                    'css'  => '.home-offer span {display: block;font-weight: 500;text-align: center;font-size: 22px;font-family: DM Serif Display;background-color:#8D7D98;padding-top: 20px;padding-bottom: 20px;}@media (max-width:768px){.home-offer span {font-size:18px;}@media (max-width:525px) {.home-offer span {font-size:14px;}}'
                ]),
            ], [
